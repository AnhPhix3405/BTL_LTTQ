-- ********************************************
-- DATABASE QUẢN LÝ GIẢNG DẠY - PHIÊN BẢN HOÀN CHỈNH
...
-- ============================================
-- 9. BẢNG: PHÂN CÔNG GIẢNG DẠY
-- ============================================
CREATE TABLE PhanCongGiangDay (
    MaPC VARCHAR(10) PRIMARY KEY,
    NgayPC DATE NOT NULL,           -- Ngày phân công
    NgayBatDau DATE NOT NULL,       -- Ngày bắt đầu học
    NgayKetThuc DATE NOT NULL,      -- Ngày kết thúc học
...
CREATE TABLE Diem (
    MaSV VARCHAR(10),
    MaLop VARCHAR(10),
    DiemCC DECIMAL(4,2) CHECK (DiemCC BETWEEN 0 AND 10),      -- Điểm chuyên cần
    DiemGK DECIMAL(4,2) CHECK (DiemGK BETWEEN 0 AND 10),      -- Điểm giữa kỳ
    DiemThi DECIMAL(4,2) CHECK (DiemThi BETWEEN 0 AND 10),    -- Điểm thi
    DiemTB AS (DiemCC * 0.1 + DiemGK * 0.3 + DiemThi * 0.6) PERSISTED,  -- Điểm trung bình
...
('PC003', '2022-08-01', '2022-09-05', '2022-12-20', '09:45:00', '11:45:00', 'A2-101', 'GV003', 'LTC003'),
('PC004', '2022-08-01', '2022-09-05', '2022-12-20', '15:15:00', '17:15:00', 'B-101', 'GV005', 'LTC004'),
